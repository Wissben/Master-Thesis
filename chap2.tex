...
\section{Schéma global d'un SPA}
	...
	\begin{itemize}
		...
		\item Puisqu'il est préférable de cacher à l'utilisateur tout comportement interne au système, il sera préférable de transformer la trame sémantique (voir ~\ref{fig:semanticFrame}) en texte naturelle pour l'afficher en sortie.
	\end{itemize}
	\paragraph{}
