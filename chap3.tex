...
%					\hline
%					\cellcolor[HTML]{EFEFEF}\textbf{Intention/arguments}                                           & \begin{tabular}[c]{@{}c@{}}file\_name \\ (Nom du fichier)\end{tabular} & \begin{tabular}[c]{@{}c@{}}directory\_name\\ (Nom du nouveau\\  répertoire)\end{tabular} & \begin{tabular}[c]{@{}c@{}}new\_directory\\ (Nom du nouveau \\ répertoire)\end{tabular} & \begin{tabular}[c]{@{}c@{}}parent\_directory\\ (Nom du répertoire\\  parent)\end{tabular} & \begin{tabular}[c]{@{}c@{}}origin\\ (origine)\end{tabular} & \begin{tabular}[c]{@{}c@{}}dest\\ (désitnation)\end{tabular} & \begin{tabular}[c]{@{}c@{}}old\_name\\ (ancien nom)\end{tabular} & \begin{tabular}[c]{@{}c@{}}new\_name\\ (nouveau nom)\end{tabular} \\ \hline
%					\begin{tabular}[c]{@{}c@{}}create\_file\_desire \\ (Fermer un fichier)\end{tabular}            & O                                                                      & -                                                                                        & -                                                                                       & O                                                                                         & -                                                          & -                                                            & -                                                                & -                                                                 \\ \hline
%					\begin{tabular}[c]{@{}c@{}}create\_directory\_desire \\ ( Créer un fichier)\end{tabular}       & -                                                                      & O                                                                                        & -                                                                                       & O                                                                                         & -                                                          & -                                                            & -                                                                & -                                                                 \\ \hline
%					\begin{tabular}[c]{@{}c@{}}delete\_file\_desire\\ (Supprimer un fichier)\end{tabular}          & O                                                                      & -                                                                                        & -                                                                                       & O                                                                                         & -                                                          & -                                                            & -                                                                & -                                                                 \\ \hline
%					\begin{tabular}[c]{@{}c@{}}delete\_directory\_desire \\ (Supprimer un répertoire)\end{tabular} & -                                                                      & O                                                                                        & -                                                                                       & O                                                                                         & -                                                          & -                                                            & -                                                                & -                                                                 \\ \hline
%					\begin{tabular}[c]{@{}c@{}}open\_file\_desire\\ (Ouvrir un fichier)\end{tabular}               & O                                                                      & -                                                                                        & -                                                                                       & O                                                                                         & -                                                          & -                                                            & -                                                                & -                                                                 \\ \hline
%					\begin{tabular}[c]{@{}c@{}}close\_file\_desire\\ (Fermer un fichier)\end{tabular}              & O                                                                      & -                                                                                        & -                                                                                       & O                                                                                         & -                                                          & -                                                            & -                                                                & -                                                                 \\ \hline
%					\begin{tabular}[c]{@{}c@{}}change\_directory\_desire\\ (Changer de répertoire)\end{tabular}    & -                                                                      & -                                                                                        & O                                                                                       & -                                                                                         & -                                                          & -                                                            & -                                                                & -                                                                 \\ \hline
%					\begin{tabular}[c]{@{}c@{}}inform  \\ (Informer)\end{tabular}                                  & O                                                                      & -                                                                                        & -                                                                                       & O                                                                                         & -                                                          & -                                                            & -                                                                & -                                                                 \\ \hline
%					\begin{tabular}[c]{@{}c@{}}request \\ (requête)\end{tabular}                                   & O                                                                      & O                                                                                        & -                                                                                       & -                                                                                         & -                                                          & -                                                            & -                                                                & -                                                                 \\ \hline
%					\begin{tabular}[c]{@{}c@{}}copy\_file\_desire \\ (copier un fichier)\end{tabular}              & -                                                                      & -                                                                                        & -                                                                                       & -                                                                                         & O                                                          & O                                                            & -                                                                & -                                                                 \\ \hline
%					\begin{tabular}[c]{@{}c@{}}move\_file\_desire \\ (déplacer un fichier)\end{tabular}            & -                                                                      & -                                                                                        & -                                                                                       & -                                                                                         & O                                                          & O                                                            & -                                                                & -                                                                 \\ \hline
%					\begin{tabular}[c]{@{}c@{}}rename\_file\_desire \\ (Renommer un fichier)\end{tabular}          & -                                                                      & -                                                                                        & -                                                                                       & -                                                                                         & -                                                          & -                                                            & O                                                                & O                                                                 \\ \hline
%					\begin{tabular}[c]{@{}c@{}}confirm \\ (Confirmer)\end{tabular}                                 & -                                                                      & -                                                                                        & -                                                                                       & -                                                                                         & -                                                          & -                                                            & O                                                                & O                                                                 \\ \hline
%					\begin{tabular}[c]{@{}c@{}}deny \\ (Refuser)\end{tabular}                                      & -                                                                      & -                                                                                        & -                                                                                       & -                                                                                         & -                                                          & -                                                            & -                                                                & -                                                                 \\ \hline
%					\begin{tabular}[c]{@{}c@{}}Unknown \\ (Inconnue)\end{tabular}                                  & -                                                                      & -                                                                                        & -                                                                                       & -                                                                                         & -                                                          & -                                                            & -                                                                & -                                                                 \\ \hline
%				\end{tabular}%
%			}
%			\caption{Liste des intentions pour la tâche d'exploration de fichiers avec leurs arguments (O = présent , - = Inutile) }
%			\label{tab:intents_set}
%		\end{table}
...
\begin{algorithm}[H]
	...
	\begin{algorithmic}[1]
		\Procedure{Step}{entrées: action\_agent; sorties: recompense, fin, succes}
		\State $\textit{tour} \gets \text{tour+1}$
		\If {$tour > \textit{max\_tour}$} 
		\State $fin \gets true$
