...
\begin{itemize}
	...
	\item Le changement de similarité: c'est-à-dire soit l'améliorer ou la diminuer.
	\item La réalisation but final.
	\item Les échanges d'informations: Nous distinguons de ces échanges la confirmation d'une question de l'agent que nous allons détailler dans la suite.
\end{itemize}
...
\begin{itemize}
	...
	\par Cette valeur $y_i$ est donc utilisée comme cible du réseau DQN et permet de calculer l'erreur moyenne quadratique par rapport à sa prédiction.
	 \[E = (y_i - Q_i(s,a))^2\]
