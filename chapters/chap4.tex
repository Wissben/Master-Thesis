...
\begin{figure}[H] 
	...
	\caption{Schéma général de l'application Speech2Act2}\label{schema_app}
\end{figure}
...
\begin{itemize}
	...
	\item \textbf{Champ de dialogue} : C'est là que vont résider toutes les informations sur le dialogue tout au long du cycle de vie de l'application. Il est mis à jour à chaque échange avec les messages échangés par l'utilisateur et l'assistant Speech2Act. Il permet ainsi de garder trace de tous les échanges effectués et pouvoir à tout moment vérifier ou réutiliser des messages.
	\begin{figure}[H]
		\centering
