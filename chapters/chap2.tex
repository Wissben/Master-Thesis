...
\end{itemize}
\paragraph{}
Il est à noter que chacun des modules seront indépendants les uns des autres dans leurs fonctionnements respectifs. Seul le format des informations qui circulent entre eux devra être établi au préalable pour un fonctionnement durable et robuste au changement.
